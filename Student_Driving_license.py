...
def mydrivinglicenseDetails():
    ...
    pin="313001"
    print(type(pin))
    address="61,Technocrate Society, Bedla Road, Udaipur , Rajasthan , India"
    print(type(address))
...
# Create a button
button1 = Button(root, text = ("Show my Driving License"), command=mydrivinglicenseDetails)
